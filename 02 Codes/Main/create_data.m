...
trn_depth = Depth_trn;
trn_fast_input_output = cat(2,trn_dat,trn_lbl_fast);
trn_slow_input_output = cat(2,trn_dat,trn_lbl_slow);
...
save(strcat(path,'trn_fast_input_output.dat'),'trn_fast_input_output','-ascii');
save(strcat(path,'trn_slow_input_output.dat'),'trn_slow_input_output','-ascii');
