...
title(sprintf('MSE = %.5f, R = %.5f',ga_mse_fast,ga_r_fast),'fontweight','bold','fontsize',font_size);
...
title(sprintf('MSE = %.5f, R = %.5f',ga_mse_slow,ga_r_slow),'fontweight','bold','fontsize',font_size);
...
ylabel(strcat('DTSM Fast (Measured)'),'fontweight','bold','fontsize',font_size);
title(sprintf('MSE = %.5f, R = %.5f',simann_mse_fast,simann_r_fast),'fontweight','bold','fontsize',font_size);
...
ylabel(strcat('DTSM Slow (Measured)'),'fontweight','bold','fontsize',font_size);
title(sprintf('MSE = %.5f, R = %.5f',simann_mse_slow,simann_r_slow),'fontweight','bold','fontsize',font_size);
...
NA = 700; % Number of Ants
alpha = 1; % alpha
beta = 0.6; % beta
roh = 0.1; % Evaporation rate
...
ylabel(strcat('DTSM Fast (Measured)'),'fontweight','bold','fontsize',font_size);
title(sprintf('MSE = %.5f, R = %.5f',aco_mse_fast,aco_r_fast),'fontweight','bold','fontsize',font_size);
...
ylabel(strcat('DTSM Slow (Measured)'),'fontweight','bold','fontsize',font_size);
title(sprintf('MSE = %.5f, R = %.5f',aco_mse_slow,aco_r_slow),'fontweight','bold','fontsize',font_size);
