...
trn_dat = table2array(readtable('./data/trn_tst/trn_dat.dat'));
trn_lbl_fast = table2array(readtable('./data/trn_tst/trn_lbl_fast.dat'));
trn_lbl_fast = trn_lbl_fast(~isnan(trn_lbl_fast));
trn_lbl_slow = table2array(readtable('./data/trn_tst/trn_lbl_slow.dat'));
